...
describe('OAuthTokenProvider', function() {
  describe('configure()', function() {
    ...
    beforeEach(function() {
      angular.module('ng-oauth2-localforage.test', [])
        .config(function(OAuthTokenProvider) {
          provider = OAuthTokenProvider;
        });

      angular.mock.module('ng-oauth2-localforage', 'ng-oauth2-localforage.test');
  ...
  describe('$get()', function() {
    beforeEach(function() {
      angular.module('ng-oauth2-localforage.test', ['angular-localforage.mock'])
